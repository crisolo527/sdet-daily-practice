...
| Risk-based test prioritization | Allocating testing effort in proportion to risk (likelihood of failure × impact if it fails), rather than testing all features/areas equally, since test time is always finite. |
